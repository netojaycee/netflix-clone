...
function Landing() {
  return (
    <>
        ...
        <div className="flex flex-row gap-5 mt-[50px] mx-auto w-[80%] justify-center">
          ...
          <div className="flex-1 mt-[55px] text-white flex flex-col">
            <p className="mt-8 flex items-center">
              <span className="mr-2 rounded-full p-2 bg-primary"></span>Explore
              Now
            </p>
            <h1 className="text-4xl mt-1 text-primary leading-9 w-full font-extrabold">
              Joker 2023
            </h1>
      ...
      <section className="border-t-[10px] border-gray-500 bg-black h-screen"></section>
      <section className="border-t-[10px] border-gray-500 bg-black h-screen"></section>
      <section className="border-t-[10px] border-gray-500 bg-black h-screen"></section>{" "}
